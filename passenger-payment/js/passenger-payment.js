...
//  Utility: Format a date string to yyyy-mm-dd
  function formatDateInput(dateStr) {
    ...
    const fullDateStr = `${dateStr}, ${currentYear}`; // Adds year
  ...
  function validatePayment() {
    ...
    // You can redirect to confirmation page or store data
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    addonsSummaryEl.innerHTML = `
      <li class="flex justify-between"><span>Ticket Price</span><span>$${ticketPrice.toFixed(2)}</span></li>
